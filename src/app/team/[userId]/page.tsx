            ...
            <div className="space-y-2">
                {shown.map(card => (
                    <Link
                        ...
                        className="flex flex-wrap items-center justify-between gap-3 bg-[var(--color-surface)] hover:bg-[var(--color-hover)] transition-colors rounded-lg border border-[var(--color-border)] px-4 py-3"
                    >
